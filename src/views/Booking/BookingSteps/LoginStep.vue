        ...
        <ul class="wrapper">
          ...
          <li class="row">
            <div class="field full">
              <input id="email" class="input empty borderless" v-model="form.email" type="email" placeholder="playboy007@caramail.com" required autocomplete="email">
          ...
          <li class="row">
            <div class="field full">
              <input id="passwordSignUp" class="input empty borderless" type="passwordSignUp" placeholder="**********" required password-reveal autocomplete="new-password">
    ...
    <div id="right" :class="loginCard ? 'panel' : 'panel inactive'">
      ...
      <form @input="check($event)" @submit.prevent="processForm" class="borderless signIn">
        ...
        <ul class="wrapper">
          ...
          <li class="row">
            <div class="field full">
              <input id="passwordSignIn" class="input empty borderless" v-model="form.passwordSignIn" type="password" placeholder="**********" required password-reveal autocomplete="new-password">
...
export default {
  ...
  methods: {
    logIn(email, password, persist) {
      ...
      this.$store.dispatch('registerLogin', {email, password, persist});
    },
    toggleView() {
